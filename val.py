...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='runs/train-G/ssdd/weights/best.pt', help='training model path')
    parser.add_argument('--data', type=str, default='ultralytics/datasets/ssdd.yaml', help='data yaml path')
    ...
    parser.add_argument('--name', type=str, default='n-c2ffasema', help='experiment name (project/name)')
