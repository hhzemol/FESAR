...
def parse_opt():
    ...
    parser.add_argument('--project', type=str, default=ROOT / 'runs/train-G', help='save to project/name')
    parser.add_argument('--name', type=str, default='s-ssdd', help='save to project/name')
