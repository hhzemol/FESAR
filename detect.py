...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='runs/train/hrsid-spd-fs-c/weights/best.pt', help='training model path')
    parser.add_argument('--source', type=str, default='yuan', help='source directory for images or videos')
